...
There are `r nrow(distinct(transit_data, line, station_name))` distinct stations. There are `r summarize(transit_data, sum(ada))` ADA-compliant stations. `r summarize(transit_data, mean(entry[vending == "NO"]))` of station entrances without vending allow entrance.
