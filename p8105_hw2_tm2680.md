...
There are 404 unique locations in the dataset `brfss_data`. Because 51 states/provinces are represented, every state and Washington, D.C. are represented. character 146 is the state most observed.
